...
{
    if(aghfp->active_indicators & aghfp_service_indicator)
    {
...
{
    if ( supportedProfileIsHfp15(aghfp->supported_profile) && (aghfp->active_indicators & aghfp_signal_strength_indicator))
    {
...
{
    if ( supportedProfileIsHfp15(aghfp->supported_profile) && (aghfp->active_indicators & aghfp_roaming_status_indicator))
    {
...
{
    if ( supportedProfileIsHfp15(aghfp->supported_profile) && (aghfp->active_indicators & aghfp_battery_charge_indicator))
    {
