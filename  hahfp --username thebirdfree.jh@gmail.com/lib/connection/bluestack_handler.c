	...
	if (state == connectionReady)
	{
		...
		switch (message->type)
		{
			...
			case DM_SM_LINK_KEY_IND: /* 11288 */
				...
				connectionHandleSmLinkKeyInd(theCm->theAppTask, &theCm->smState, (DM_SM_LINK_KEY_IND_T*)message);
				return;
			...
			case DM_SM_LINK_KEY_REQUEST_IND: /* 11302 */
				PRINT(("DM_SM_LINK_KEY_REQUEST_IND\n"));
				connectionHandleSmLinkKeyReqInd(theCm->theAppTask, &theCm->smState, (DM_SM_LINK_KEY_REQUEST_IND_T*)message);
				return;
		...
		switch (message->type)
		{
			...
			case DM_SM_INIT_CFM:
                    ...
                    if (state == connectionInitialising)
				{
                         ...
                         */
                        handleSecurityInitCfm((DM_SM_INIT_CFM_T *)message);
				}
...
static void connectionBluestackHandlerInitialising(connectionState *theCm, MessageId id, Message message)
{
	...
	switch (id)
	{
        ...
        case CL_INTERNAL_SM_INIT_REQ:
            ...
            handleSecurityInitReq((CL_INTERNAL_SM_INIT_REQ_T *)message);
		    break;
...
static void connectionBluestackHandlerReady(connectionState *theCm, MessageId id, Message message)
{
	...
	switch(id)
	{
		...
		case CL_INTERNAL_SM_SET_TRUST_LEVEL_REQ:
            ...
            handleSetTrustLevelReq((CL_INTERNAL_SM_SET_TRUST_LEVEL_REQ_T*)message);
		    break;
