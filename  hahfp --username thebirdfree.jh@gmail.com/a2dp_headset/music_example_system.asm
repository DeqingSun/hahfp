...
// Get Current System Mode
   ...
   // see if mono or stereo connection, based on whether the right output port is enabled

   // Determine the mono mode from mode (default to PASSTHRU)
   r2 = $music_example.SYSMODE.MONO_PASSTHRU;

   r3 = $music_example.SYSMODE.MONO_STANDBY;
   Null = r1 - $music_example.SYSMODE.STANDBY;
   if Z r2 = r3;
