...
# Generated: ¿ù 8 13 19:29:12 2012
#                                                          
...
OUTDIR=d:/work/hahfp
HARDWARE_INDEX=9
DEFS=-DDEBUG_PRINT_ENABLED -DENABLE_AVRCPx -DBC5_MULTIMEDIA -DENABLE_PBAPx -DROM_LEDS -DINCLUDE_DSP -DINCLUDE_CVC -DTHREE_WAY_CALLING 
...
LIBS=-lavrcp -lpower -lconnection -lbdaddr -lhfp_min_cfm -lregion -lservice -lcodec_nowolfson -lcsr_tone_plugin -laudio_vp -lcsr_cvc_common_plugin_all_debug -lcsr_voice_prompts_plugin_file_only_dsp -lcsr_a2dp_decoder_common_plugin_stereo -la2dp -lcsr_common_example_plugin -lgoep -lgoep_apphdrs -lpbap_common -lpbapc -lsdp_parse -lmd5 
INPUTS=\
      headset.mak\
      main.c\
      headset_init.c\
