...
/*!
   @brief Setting this flag in profile_extensions field while library 
   initialisation, turns on all AVRCP 1.4 features.
*/
...
typedef enum
{
    ...
    /*! Operation was successful, but have only received an
      interim response.*/
...
/*!
    @brief This message is generated as a result of a call to the
    AvrcpConnectRequest .
*/
typedef struct
{
...
/*!
    ...
    AvrcpBrowseConnectRequest() API function.
*/
typedef struct
{
    AVRCP                *avrcp;  /*!< Pointer to AVRCP profile instance. */
...
/*!
    ...
    Browsing channel. Application must respond to this message using 
...
/*!
    ...
    supported capabilities of the remote device. This is generated as a result
    of call to the AvrcpGetCapsRequest.
*/
typedef struct
{
    /*! Pointer to avrcp profile instance. */
...
/*!
    ...
    of the  remote device. This message is generated as a result of a call
    to the AvrcpListAppAttributeRequest.
*/
typedef struct
{
    /*! Pointer to avrcp profile instance. */
...
/*!
    ...
    This message is generated as a result of a call to the 
    AvrcpListAppValueRequest.
...
/*!
    @brief This message is confirmation of retrieving the attribute text of 
    the  remote device.
*/
typedef struct
{
...
/*!
    @brief This message contains the failure confirmation for the 
    avrcpRegisterNotificationRequest. This message will be generated
    if the library is not able to send Register Notification command to 
    the Target device or the Target device is not responding for the 
    Registered event on time. On success, application will not receive 
    this event and it will received the corresponding event indication
    messages.
*/
typedef struct
{
...
/*!
    @brief This message is an indication to the controller on
receiving EVENT_ADDRESSED_PLAYER_CHANGED event from the Target device.
*/
...
/*!
    @brief This message is an indication to the controller on
receiving EVENT_AVAILABLE_PLAYERS_CHANGED event from the Target device.
*/
...
/*!
    @brief This message is an indication to the controller on
receiving EVENT_UIDS_CHANGED event from the Target device.
*/
...
/*!
    @brief This message is an indication to the controller on
receiving EVENT_NOW_PLAYING_CONTENT_CHANGED event from the Target device.
*/
...
operation for AvrcpSetAbsoluteVolumeRequest().
*/
typedef struct{
    /*! Profile Instance */
    AVRCP             *avrcp; 
...
/*!
    @brief This message is generated as a result of a call to 
    AvrcpSetAddressedPlayerRequest() API function.
*/
...
/*!
    @brief This message is generated as a result of a call to 
    AvrcpPlayItemRequest() API function.
*/
...
/*!
    @brief This message is generated as a result of a call to 
    AvrcpAddToNowPlayingRequest() API function.
*/
...
/*!
    @brief This message is generated as a result of a call to 
    AvrcpBrowseSetPlayerRequest API function. On success it returns the 
...
/*!
    ...
    AvrcpBrowseChangePathRequest API function. On success it returns the number 
...
/*!
    @brief This message is generate as a result of a call to 
    AvrcpBrowseGetItemAttributesRequest API function. On success it returns 
    ...
    value entry contains a 4 octet attribute Id, 2 octet character set value,
    2 octet attribute value length followed by a attribute value string. 
*/
...
/*!
    @brief This message is generate as a result of a call to 
    AvrcpBrowseGetFolderItemsRequest API function. On success it returns 
    ...
    respectively. Media element item will contain a attribute value list
...
/*!
    @brief This message is generate as a result of a call to 
    AvrcpBrowseSearchRequest API function. On success it returns the new UID 
...
/*!
    ...
    uid=0x0 is a special value to request the Metadata of the currently
...
/*!
    ...
    attr_list field will be set to 0 if num_attr=0 or 255.
    For any other value of num_attr, size of the attributes in the attr_list
    will be 4*num_attr. num_attr=0 is a special value to request for all 
    attributes and num_attr=255 is a request for no attributes. All attribute
    IDS in the list are defined in the interface header file under "List of 
...
/*!
    @brief This message is an indication to the Target on 
    receiving Search request from the Controller device. Target must response
    with AvrcpBrowseSearchResponse() on receiving this message indication.
...
/*!
    ...
    AVRCP_BROWSE_CONNECT_CFM message will be received by the application.
*/
...
/*!
    ...
    This function is called on receipt of an AVRCP_BROWSE_CONNECT_IND message.
    The AVRCP_BROWSE_CONNECT_IND message contains the remote devices 
    Bluetooth address.
*/
...
/*!
    ...
    AVRCP_BROWSE_DISCONNECT_IND message will be received by the application.
*/
...
/*!
    ...
    player Feature bit mask  retrieved using AvrcpGetFolderItems()
    for any particular media player item. Profile extension values returned
...
/*!
    ...
    target on the connection identified by the profile instance. The
    Application  shall pay  attention on the state flag. On each button
...
/*!
    ...
    attributes list. A AVRCP_GET_APP_VALUE_CFM message will be returned
...
/*!
    ...
    A AVRCP_SET_ADDRESSED_PLAYER_CFM message will be returned with the result 
    for this request.
*/
...
/*!
    ...
    AvrcpBrowseGetFolderItems() request or AvrcpBrowseSearchRequest or through
    the Event Notifications like  AVRCP_EVENT_UIDS_CHANGED_IND or
    AVRCP_EVENT_ADDRESSED_PLAYER_CHANGED_IND. 

    A AVRCP_PLAY_ITEM_CFM message will be returned with the result 
    for this request.
*/
...
/*!
    ...
    A AVRCP_ADD_TO_NOW_PLAYING_CFM message will be returned with the result 
    for this request.
*/
...
/*!
    ...
    A AVRCP_BROWSE_SET_PLAYER_CFM message will be returned with the result 
    for this request.
*/
...
/*!
    ...
    @param uid   The UID of the folder item. Item_list returned
    ...
    A AVRCP_BROWSE_CHANGE_PATH_CFM message will be returned with the result 
    for this request.
*/
...
/*!
    ...
    A AVRCP_BROWSE_GET_ITEM_ATTRIBUTES_CFM message will be returned with the 
...
/*!
    ...
    that the Start index. If the application requests too many Items, TG 
    ...
    A AVRCP_BROWSE_GET_FOLDER_ITEMS_CFM message will be returned with the 
    result  for this request.
*/
...
/*!
    ...
    @param char_type Character Set used for search string. This must be 
    ...
    A AVRCP_BROWSE_SEARCH_CFM message will be returned with the 
    result  for this request.
*/
...
/*!
    ...
    This function is sent in response to a AVRCP_GET_APP_VALUE_TEXT_IND
    message being received by the client.
...
/*!
    ...
    This will be called in response to a AVRCP_INFORM_CHARACTER_SET_IND 
    message.
*/
...
/*!
    ...
    This will be called in response to a AVRCP_SET_ADDRESSED_PLAYER_IND
    message.
*/
...
/*!
    ...
    The TG must call this function when the addressed player has changed, if 
    avrcp_event_addressed_player_changed notification was previously 
    registered by the CT. 
*/
...
/*!
    ...
    The TG must call this function when the available players has changed, if 
    avrcp_event_available_players_changed notification was previously 
    registered by the CT. 
*/
...
/*!
    ...
    avrcp_response_rejected_invalid_scope etc.
     ...
     This will be called in response to a AVRCP_PLAY_ITEM_IND message.
*/
...
/*!
    ...
    avrcp_response_rejected_play_list_full etc.
     ...
     This will be called in response to a AVRCP_ADD_TO_NOW_PLAYING_IND message.
*/
...
/*!
   ...
   UIDs  changed event at TG.
    ...
    @param response Response indicating whether the UIDs has been changed
    ...
    The TG must call this function when the  UIDs has been changed, if 
    avrcp_event_uids_changed notification was previously 
    registered by the CT. 
*/
...
/*!
    ...
    has been changed on the current media player on TG, if 
    avrcp_event_now_playing_content_changed notification was previously 
    registered by the CT. 
*/
...
/*!
    ...
    Each attribute value entry contains a 4 octet attribute Id, 2 octet 
    character set value, 2 octet attribute value length followed by a 
...
/*!
    ...
    @param item_list List of items retuned. Items includes Media player item,
