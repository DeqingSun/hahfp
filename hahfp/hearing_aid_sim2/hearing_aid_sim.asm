//******************************************************************************
// Copyright (C) Cambridge Silicon Radio plc 2010 http://www.csr.com
// *****************************************************************************
// *****************************************************************************
// DESCRIPTION
...
.define $AUDIO_CBUFFER_SIZE            300
.define $DATA_COPIED                   0
.define $DATA_NOT_COPIED               1
.define $TONES_BLOCK_SIZE              128
...
.MODULE $M.main;
   ...
   .CONST  $TONE_PORT              ($cbuffer.READ_PORT_MASK + 3);
