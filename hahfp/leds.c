...
Copyright (C) Cambridge Silicon Radio Ltd. 2006-2010
	...
	HeadsetSDK-Stereo 110.0 (wasbu_build 19-Aug-2010 13:54:11) and provides simple LED indications.
*****************************************************************************/
...
/*LEDS_EVENT_HA_MODE*/ 
static const ledEntry_t pattern_LEDS_EVENT_HA_MODE [ 2 ] = 
{
    { 0x8000 , ON  , 5000 }  , 
    { 0xC000 , OFF , 100  }  
}; 
/*LEDS_EVENT_BT_MODE*/ 
static const ledEntry_t pattern_LEDS_EVENT_BT_MODE [ 2 ] = 
{
    { 0xC000 , ON  , 5000 }  , 
    { 0xC000 , OFF , 100  }  
}; 
/*LEDS_EVENT_RX_MODE*/ 
static const ledEntry_t pattern_LEDS_EVENT_RX_MODE [ 2 ] = 
{
    { 0x4000 , ON  , 5000 }  , 
    { 0xC000 , OFF , 100  }  
}; 
/*LEDS_HA_MODE_RPT*/ 
static const ledEntry_t pattern_LEDS_HA_MODE_RPT [ 1 ] = 
{
    { 0xC000 , OFF , 0    }  
}; 
/*LEDS_BT_MODE_RPT*/ 
static const ledEntry_t pattern_LEDS_BT_MODE_RPT [ 2 ] = 
{
    { 0xC000 , OFF , 2900 }  , 
    { 0xC000 , ON  , 100  }  
}; 
/*LEDS_RX_MODE_RPT*/ 
static const ledEntry_t pattern_LEDS_RX_MODE_RPT [ 2 ] = 
{
    { 0x4000 , OFF , 2900 }  , 
    { 0x4000 , ON  , 100  }  
}; 
/*BLUE_ON_RPT*/ 
static const ledEntry_t pattern_BLUE_ON_RPT [ 1 ] = 
{
    { 0x8000 , ON  , 0    }  
}; 
/*LEDS_LOW_BATT_RPT*/ 
...
/*LEDS_TALK_RPT*/ 
static const ledEntry_t pattern_LEDS_TALK_RPT [ 2 ] = 
{
    { 0xC000 , OFF , 500  }  , 
    { 0xC000 , ON  , 500  }  
}; 
/*BLUE_BLINK_RPT*/ 
static const ledEntry_t pattern_BLUE_BLINK_RPT [ 2 ] = 
{
    { 0x8000 , OFF , 500  }  , 
    { 0x8000 , ON  , 500  }  
}; 
/*RED_ON_RPT*/ 
static const ledEntry_t pattern_RED_ON_RPT [ 1 ] = 
{
    { 0x4000 , ON  , 0    }  
}; 
/*RED_BLINK_RPT*/ 
static const ledEntry_t pattern_RED_BLINK_RPT [ 2 ] = 
{
    { 0x4000 , OFF , 500  }  , 
    { 0x4000 , ON  , 500  }  
}; 
/*RED_SHORT_OFF_RPT*/ 
static const ledEntry_t pattern_RED_SHORT_OFF_RPT [ 2 ] = 
{
    { 0x4000 , ON  , 2400 }  , 
    { 0x4000 , OFF , 100  }  
}; 
/*BLUE_LONG_ON_RPT*/ 
static const ledEntry_t pattern_BLUE_LONG_ON_RPT [ 2 ] = 
{
    { 0x8000 , ON  , 100  }  , 
    { 0x8000 , OFF , 9900 }  
}; 
/*RED_LONG_ON_RPT*/ 
static const ledEntry_t pattern_RED_LONG_ON_RPT [ 2 ] = 
{
    { 0x4000 , ON  , 100  }  , 
    { 0x4000 , OFF , 9900 }  
}; 
/*RED_BLUE_BOTH_SHORT_ON_RPT*/ 
static const ledEntry_t pattern_RED_BLUE_BOTH_SHORT_ON_RPT [ 2 ] = 
{
    { 0xC000 , ON  , 100  }  , 
    { 0xC000 , OFF , 2400 }  
}; 
...
static const led_t gLeds [ LED_NUM_PATTERNS ] = 
{
    ...
    {  { 2,  0x00 , OFF }, (ledEntry_t *) pattern_LEDS_EVENT_HA_MODE } ,

    {  { 2,  0x00 , OFF }, (ledEntry_t *) pattern_LEDS_EVENT_BT_MODE } ,

    {  { 2,  0x00 , OFF }, (ledEntry_t *) pattern_LEDS_EVENT_RX_MODE } ,

    {  { 1,  0x00 , RPT }, (ledEntry_t *) pattern_LEDS_HA_MODE_RPT } ,

    {  { 2,  0x00 , RPT }, (ledEntry_t *) pattern_LEDS_BT_MODE_RPT } ,

    {  { 2,  0x00 , RPT }, (ledEntry_t *) pattern_LEDS_RX_MODE_RPT } ,

    {  { 1,  0x00 , RPT }, (ledEntry_t *) pattern_BLUE_ON_RPT } ,

    {  { 2,  0x00 , RPT }, (ledEntry_t *) pattern_LEDS_LOW_BATT_RPT } ,

    {  { 2,  0x00 , RPT }, (ledEntry_t *) pattern_LEDS_TALK_RPT } ,

    {  { 2,  0x00 , RPT }, (ledEntry_t *) pattern_BLUE_BLINK_RPT } ,

    {  { 1,  0x00 , RPT }, (ledEntry_t *) pattern_RED_ON_RPT } ,

    {  { 2,  0x00 , RPT }, (ledEntry_t *) pattern_RED_BLINK_RPT } ,

    {  { 2,  0x00 , RPT }, (ledEntry_t *) pattern_RED_SHORT_OFF_RPT } ,

    {  { 2,  0x00 , RPT }, (ledEntry_t *) pattern_BLUE_LONG_ON_RPT } ,

    {  { 2,  0x00 , RPT }, (ledEntry_t *) pattern_RED_LONG_ON_RPT } ,

    {  { 2,  0x00 , RPT }, (ledEntry_t *) pattern_RED_BLUE_BOTH_SHORT_ON_RPT } 
};
