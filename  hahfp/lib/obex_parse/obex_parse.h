...
/*!
    ...
    e.g: An object <a> <b> <c>1</c> <d>2</d> </b> <e> 3 </e> <a>  has 3
    levels (level 0 at <a> level 1 at <b>,<e> and level 2 at <c>,<d>) and 
    this API  parses only 1 level down and creates a tree of 2 elements with
    element 1 points to <b> and element 2 points to <e>. The application 
    must call  this API again using the data pointer of element <b> to 
    parse the  next level to retrieve the elements <c> and <d>.    
