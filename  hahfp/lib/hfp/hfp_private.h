...
#ifndef HFP_MAX_LINKS
#define HFP_MAX_LINKS           2
#endif

#ifndef HFP_SERVICES_PER_LINK
#define HFP_SERVICES_PER_LINK   2
#endif

#define HFP_NUM_SERVICES        HFP_MAX_LINKS * HFP_SERVICES_PER_LINK
...
typedef struct
{
    ...
    hfp_link_data               links   [HFP_MAX_LINKS];    /* Array of HFP links                                   */
    hfp_service_data            services[HFP_NUM_SERVICES]; /* Array of HFP services                                */
} hfp_task_data;
...
/* Audio connection */
/*0x1E*/    HFP_INTERNAL_AUDIO_TRANSFER_REQ,
/*0x1F*/    HFP_INTERNAL_AUDIO_CONNECT_REQ,
/*0x20*/    HFP_INTERNAL_AUDIO_CONNECT_RES,
/*0x21*/    HFP_INTERNAL_AUDIO_DISCONNECT_REQ,
    
/* CSR Extensions */
/*0x22*/    HFP_INTERNAL_CSR_SUPPORTED_FEATURES_REQ,
/*0x23*/    HFP_INTERNAL_CSR_BATTERY_LEVEL_REQ,
/*0x24*/    HFP_INTERNAL_CSR_POWER_SOURCE_REQ,
/*0x25*/    HFP_INTERNAL_CSR_MOD_INDS_REQ,
/*0x26*/    HFP_INTERNAL_CSR_MOD_INDS_DISABLE_REQ,
/*0x27*/    HFP_INTERNAL_CSR_GET_SMS_REQ,
/*0x28*/    HFP_INTERNAL_CSR_AG_BAT_REQ,
        
/* WB-Speech Messages */
/*0x29*/    HFP_INTERNAL_AT_BAC_REQ,

/* HSP */
/*0x2A*/    HFP_INTERNAL_HS_INCOMING_TIMEOUT_LINK_0_IND,
/*0x2B*/    HFP_INTERNAL_HS_INCOMING_TIMEOUT_LINK_1_IND,
/*0x2C*/    HFP_INTERNAL_AT_CKPD_REQ,
    
/* Top internal message */
/*0x2D*/    HFP_INTERNAL_TOP,
    
/* Defined here so its not visible outside this lib */
/*0x2E*/    HFP_COMMON_CFM_MESSAGE,
/*0x2F*/    HFP_COMMON_INTERNAL_MESSAGE
};
