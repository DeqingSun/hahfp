...
void a2dpProfileHandler(Task task, MessageId id, Message message)
{
    ...
    case A2DP_INTERNAL_SIGNALLING_CONNECT_REQ:
        ...
        a2dpHandleL2capSignallingConnectReq((A2DP_INTERNAL_SIGNALLING_CONNECT_REQ_T *) message);
        break;

    case A2DP_INTERNAL_SIGNALLING_CONNECT_RES:
        PRINT(("A2DP_INTERNAL_SIGNALLING_CONNECT_RES\n"));
        a2dpHandleL2capConnectRes((A2DP_INTERNAL_SIGNALLING_CONNECT_RES_T *) message);
        break;

    case A2DP_INTERNAL_SIGNALLING_DISCONNECT_REQ:
        PRINT(("A2DP_INTERNAL_SIGNALLING_DISCONNECT_REQ\n"));
        a2dpHandleL2capSignallingDisconnectReq((A2DP_INTERNAL_SIGNALLING_DISCONNECT_REQ_T *) message);
        break;

#if 0
    case A2DP_INTERNAL_MEDIA_CONFIGURE_RSP:
        PRINT(("A2DP_INTERNAL_MEDIA_CONFIGURE_RSP\n"));
        a2dpHandleConfigureCodecRes((A2DP_INTERNAL_MEDIA_CONFIGURE_RSP_T *) message);
        break;
#endif
