...
void profileSlcConnectCfm (devInstanceTaskData *inst, mvdProfiles profile, bool remote_connecting)
{
   ...
   all_responded = ( (inst->responding_profiles & (ProfileAvrcp | ProfileA2dp)) == 
                  ( (inst->remote_profiles & (ProfileAvrcp | ProfileA2dp)) & 
                    (the_app->supported_profiles & (ProfileAvrcp | ProfileA2dp))) );
